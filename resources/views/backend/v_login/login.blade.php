...
<!-- Favicon icon -->
<link rel="icon" type="image/png" sizes="16x16" href="{{asset('backend/images/khoceng.png') }}">
<title>Toko Kocheng</title>
<!-- Custom CSS -->
    ...
    <div class="auth-box bg-dark border-top border-secondary">
        <div id="loginform">
            <div class="text-center p-t-20 p-b-20">
                <span class="db">
                    <img src="{{ asset('backend/images/khoceng.png') }}" alt="logo" class="w-50 h-auto" />
                </span>
            </div>
